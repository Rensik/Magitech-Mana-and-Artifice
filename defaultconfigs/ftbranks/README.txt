...
Last README file update: Thu Oct 01 08:30:23 EDT 2020
...
command.night
command.omegamute
command.omegamute.cull
command.omegamute.cull.cull-time
command.omegamute.cull.cull-time.string-contains
command.omegamute.listen
command.omegamute.mute
command.omegamute.mute.string-contains
command.omegamute.query
command.omegamute.reload
command.omegamute.unmute
command.omegamute.unmute.string-contains
command.particle
...
command.seed
command.setFaction
command.setFaction.player
command.setFaction.player.faction
command.setMagicLevel
command.setMagicLevel.player
command.setMagicLevel.player.level
command.setTier
command.setTier.player
command.setTier.player.tier
command.setblock
...
command.tpa
command.tpa.targetPlayer
command.tpaccept
command.tpaccept.targetPlayer
command.tpahere
command.tpahere.targetPlayer
command.tpall
command.tpdeny
command.tpdeny.targetPlayer
command.trash
command.trigger
